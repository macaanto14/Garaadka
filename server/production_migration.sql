...
-- ========================================================================
-- This script migrates your development database to production
-- Run this script on your production database server
-- 
-- IMPORTANT: 
-- 1. Backup your existing production database before running this script
-- 2. Update the environment variables in your .env.production file
-- 3. Test this script on a staging environment first
-- ========================================================================
...
-- Table: audit (for system audit logging)
...
-- Table: user accounts (legacy table name for compatibility)
...
-- Table: register (legacy table for backward compatibility)
...
-- Business Information (UPDATE THESE VALUES FOR YOUR BUSINESS)
...
SELECT COUNT(*) AS total_tables FROM information_schema.tables WHERE table_schema = 'loundary';
SELECT COUNT(*) AS total_views FROM information_schema.views WHERE table_schema = 'loundary';
