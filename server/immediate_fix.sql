-- Immediate fix for the duplicate key error
-- This script only adds the missing customer_type column and creates working views

USE `gwldb`;

-- Add customer_type column to existing customers table
...
-- Add missing columns to orders table (optional)
ALTER TABLE `orders` 
...
-- Test the views
SELECT 'Immediate fix applied successfully!' AS status;
